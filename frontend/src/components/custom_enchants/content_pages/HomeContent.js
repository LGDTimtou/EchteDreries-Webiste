    ...
    return (
        <div>
            ...
            <div>
                ...
                <div className="parameters-section">
                    ...
                    <p className="minecraft offset">
                        With this plugin, you can define <strong>fully customizable enchantments</strong> that behave
                        exactly like vanilla — usable in <strong>enchantment
                        tables</strong>, <strong>anvils</strong>, <strong>villager trades</strong>, <strong>mob
                        drops</strong>, and <strong>loot chests</strong>. But it doesn’t stop there.
                    </p>
                    <p className="minecraft offset">
                        Go beyond vanilla by defining your own logic, conditions, and effects. Whether you want to
                        trigger effects <strong>on hit</strong>, <strong>on block break</strong>, or even <strong>when a
                        player chats</strong> — there are <strong>{triggers.length} powerful
                        triggers</strong> available.
                    </p>
                    <p className="minecraft offset">
                        And the best part? You don’t need to write a single line of config. Use the intuitive <strong>visual
                        web builder</strong> to create and manage enchantments <strong>without any hassle</strong>.
                    </p>
            ...
            <div className="parameters-section">
                ...
                <p className="minecraft offset">
                    Watch this short video to get a quick feel for the plugin and learn how to create your first custom
                    enchantment:
                </p>
