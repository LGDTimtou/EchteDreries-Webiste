                        ...
                        return {
                            ...
                            fields: condition.values.map((triggerConditionValue) => {
                                const matched = match.possible_values.find(
                                    (value) => value.name === triggerConditionValue.value.toString().toLowerCase()
                                );

                                if (matched) return {...matched, subValue: triggerConditionValue.operator};

                                return {
                                    name: triggerConditionValue.value.toString().toLowerCase(),
                                    label: toTitleCase(triggerConditionValue.value.toString().toLowerCase()),
